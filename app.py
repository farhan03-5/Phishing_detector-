...
from database import save_scan, get_user_scans
...
# ---------------- DASHBOARD ----------------
    ...
    if total > 0:
        ...
        st.info("No data available yet. Analyze some emails first.")

# ---------------- ABOUT ----------------
elif menu == "ℹ️ About":
    st.title("About")

    st.write("AI-based phishing detection system built using ML + Cybersecurity." \
    "Created by Farhan Khan / Farhaan891999@gmail.com")
